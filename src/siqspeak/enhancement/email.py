...
EMAIL_SYSTEM_MESSAGE = (
    ...
    "Produce a greeting line addressed to the recipient. If the dictation names a\n"
    "recipient (e.g. 'email to John Luca', 'tell Sarah that...'), greet them by FIRST\n"
    "name only ('Hi John,') — never include a surname, title, or honorific. When NO\n"
    "recipient is named, use the literal placeholder [name] ('Hi [name],'); never invent\n"
    "a recipient. Produce a clear body of one or more sentences or paragraphs that\n"
    "conveys the user's message. Produce a brief closing line such as 'Thanks,'.\n"
